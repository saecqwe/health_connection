...
import 'package:health_connection/presentation/screens/Tasks/task_appointment.dart';
              ...
              children: [
                ...
                const  Text(
                  ...
                  Text.rich(TextSpan(children: [
                    ...
                    TextSpan(
                      text:
                          "is not a simple yes / no or singular item, but rather it is an interconnected and interdependent concept involving multiple areas of health that impact your overall wellness & quality of life. ",
                      style: basicStyle(
                          size: 16,
                          color: AppColors.blackColor,
                          fontWeight: FontWeight.normal),
                    ...
                    TextSpan(
                      text: "allows you to create beneficial ",
                      style: basicStyle(
                          size: 16,
                          color: AppColors.blackColor,
                          fontWeight: FontWeight.normal),
                    ...
                    TextSpan(
                      text: "Mental Health Connections.",
                      style: basicStyle(
                          size: 16,
                          color: AppColors.blackColor,
                          fontWeight: FontWeight.bold),
